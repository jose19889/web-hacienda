      ...
      <div class="container">
         ...
         <div class="row">
           <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
            <h2 class="line"><span>Organos Bajo Tutela</span></h2>
               <div class="row h-50">
                 ...
                 <div class="col-md-4 col-sm-6 co-xs-12 ">
                  <br> <br>
                   <h2 class="line"><span></span></h2>
                    <picture>
                       <a href="">
                             <img src="<?php echo get_template_directory_uri(); ?>/img/hr2020.png"  alt="yo" class=" img-responsive " alt="Responsive image"/>
                          </a>
                    </picture>
